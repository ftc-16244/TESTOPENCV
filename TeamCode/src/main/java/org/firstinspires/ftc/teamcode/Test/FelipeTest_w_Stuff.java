...
import org.firstinspires.ftc.teamcode.Subsystems.Felipe_w_Linear_Stuff;
 ...
 */
@TeleOp(group = "Test")
public class FelipeTest_w_Stuff extends LinearOpMode {

    Felipe_w_Linear_Stuff felipe = new Felipe_w_Linear_Stuff(); // instantiate Felipe (the main implement)
